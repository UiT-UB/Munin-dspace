...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <!-- KM: Front page submission box -->
    <xsl:template name="submission-box">
      <div class="submission-box">
	<a class="list-group-item active" href="https://iportal.uit.no/mydspace">

	  <div class="big">
	    <i18n:text>ub.xmlui.dri2xhtml.Reference.submissionbox-1</i18n:text>
	  </div>
	  
	  <div class="small">
	    <i18n:text>ub.xmlui.dri2xhtml.Reference.submissionbox-2</i18n:text>
	  </div>
