...
public class ItemRequestForm extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
    ...
    //KMS: Add message help text
    private static final Message T_message_help = 
        message("ub.xmlui.ArtifactBrowser.ItemRequestForm.message_help");
    //KME
	...
	public void addBody(Body body) throws SAXException, WingException,
		...
		//KMS: Add message help text
		message.setHelp(T_message_help);
		//KME
