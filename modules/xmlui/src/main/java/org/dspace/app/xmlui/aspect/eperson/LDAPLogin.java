...
public class LDAPLogin extends AbstractDSpaceTransformer implements
    ...
    //KMS: Login info
    public static final Message T_intro1 = message("ub.xmlui.EPerson.LDAPLogin.intro1");
    public static final Message T_intro2 = message("ub.xmlui.EPerson.LDAPLogin.intro2");
    public static final Message T_intro3 = message("ub.xmlui.EPerson.LDAPLogin.intro3");
    //KME
	...
	public void addBody(Body body) throws SQLException, SAXException,
		...
		//KMS: Add login info
		Para pIntro1 = login.addPara("login-info1", "login-info");
		pIntro1.addContent(T_intro1);
		Para pIntro2 = login.addPara("login-info2", "login-info");
		pIntro2.addContent(T_intro2);
		Para pIntro3 = login.addPara("login-info3", "login-info");
		pIntro3.addContent(T_intro3);

		//login.addPara(T_intro1, "login-info");
		//login.addPara(T_intro2, "login-info");
		//login.addPara(T_intro3, "login-info");
		//KME
