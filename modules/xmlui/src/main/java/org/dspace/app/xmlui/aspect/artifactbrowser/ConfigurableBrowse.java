        ...
        CacheableProcessingComponent
{
            ...
            throws WingException
    {
	    ...
	    //KMS: Add Norwegian letters to list of letters in the browse pages
	    letterQuery.put(BrowseParams.STARTS_WITH, Character.toString('\u00C6'));
	    jumpList.addItemXref(super.generateURL(BROWSE_URL_BASE, letterQuery), Character
				 .toString('\u00C6'));
	    
	    letterQuery.put(BrowseParams.STARTS_WITH, Character.toString('\u00D8'));
	    jumpList.addItemXref(super.generateURL(BROWSE_URL_BASE, letterQuery), Character
				 .toString('\u00D8'));
	    
	    letterQuery.put(BrowseParams.STARTS_WITH, Character.toString('\u00C5'));
	    jumpList.addItemXref(super.generateURL(BROWSE_URL_BASE, letterQuery), Character
				 .toString('\u00C5'));
	    //KME
