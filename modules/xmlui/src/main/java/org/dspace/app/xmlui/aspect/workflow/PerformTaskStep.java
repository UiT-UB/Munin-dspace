...
public class PerformTaskStep extends AbstractStep
{
    ...
    //KMS: New message
    protected static final Message T_internal_id = message("ub.xmlui.general.internal_id");
    //KME
	...
	//KMS: Show item's internal id
	Para p = div.addPara(null, null);
    	p.addContent(T_internal_id);
	p.addContent(": ");
	p.addContent(item.getID());
	//KME    	
	...
	//KMS: Changed button order (orig: approve, edit, reject, return)
