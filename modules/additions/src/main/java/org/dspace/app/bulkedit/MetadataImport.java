...
public class MetadataImport
{
            ...
            for (DSpaceCSVLine line : toImport)
            {
                ...
                else
                {
                    ...
                    if (change)
                    {
                        ...
                        if(useWorkflow){
							//KM: DEBUG
							System.out.println("useWorkflow 1");
                            if (ConfigurationManager.getProperty("workflow", "workflow.framework").equals("xmlworkflow")) {
								//KM: DEBUG
								System.out.println("useWorkflow 2");
                                if (workflowNotify) {
								//KM: DEBUG
								System.out.println("useWorkflow 3");
                                    XmlWorkflowManager.start(c, wsItem);
                                } else {
								//KM: DEBUG
								System.out.println("useWorkflow 4");
                                    XmlWorkflowManager.startWithoutNotify(c, wsItem);
                                }
                            } else {
                                if (workflowNotify) {
									//KM: DEBUG
									System.out.println("workflowNotify");
    ...
    public static void main(String[] argv)
    {
        ...
        {
			//KM: DEBUG
			System.out.println("Finner workflow");
            useWorkflow = true;
            if (line.hasOption('n'))
            {
                workflowNotify = true;
