...
<xsl:stylesheet 
	...
	<xsl:template match="/">
		<oai_dc:dc xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/" 
			...
			<!-- KM: Added dc.contributor.authhorexternal to dc:creator -->
			<!-- dc.contributor.authorexternal -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='contributor']/doc:element[@name='authorexternal']/doc:element/doc:field[@name='value']">
				<dc:creator><xsl:value-of select="." /></dc:creator>
			</xsl:for-each>
			<!-- KM: Hide all other qualified contributor fields (in particular the dc.contributor.advisor field) -->
			<!-- dc.contributor.* (!author) -->
			<!--
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='contributor']/doc:element[@name!='author']/doc:element/doc:field[@name='value']">
			...
			<!-- KM: Add dc.description.abstract specifically here, and do not include the other description fields at all -->
